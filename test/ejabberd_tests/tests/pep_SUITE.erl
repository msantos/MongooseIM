...
subscribe_presence(User1, User2) ->
    SubscribeIq = escalus_stanza:presence_direct(
                                            escalus_utils:get_short_jid(User2),
                                            <<"subscribe">>),
    ...
    SubscribedIq = escalus_stanza:presence_direct(
                                            escalus_utils:get_short_jid(User1),
                                            <<"subscribed">>),
